...
/obj/structure/alien/resin/flower_bud/run_obj_armor(damage_amount, damage_type, damage_flag = 0, attack_dir)
...
/mob/living/simple_animal/hostile/venus_human_trap/RangedAttack(atom/victim)
	if(!combat_mode)
		return
